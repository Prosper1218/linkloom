...
const Messages = () => {
   ...
   return (
      <div className="" style={{backgroundColor: theme ? "#2222" : "#F7F7F8", color: theme === "dark" ? "#F7F7F8" : "#2222"}}>
         <div className="ml-[2.4rem] mt-1 sm:ml-0 flex justify-between items-start">
            <h1 className="font-sans font-bold text-[#A303A0] text-md sm:text-lg">Messages</h1>
