...
const CoverPhoto = () => {
   ...
   return (
      <div className="relative z-10 mt-4 bg-white pb-5 rounded-b-[8px]">
         ...
         <button
            className=" z-20 text-[#490057] w-[6rem] h-[1.7rem] sm:w-[7rem] sm:h-[2rem] text-[60%] rounded-md bg-white top-[10rem] sm:top-[11rem] right-[1rem] sm:right-[1.9rem] font-semibold  absolute font-sans"
         ...
         <div className="">
            ...
            <div className="relative flex flex-row justify-between  px-[1rem] sm:px-[1.9rem]">
               <div className="ml:0 sm:ml-3 pr-6 leading-3 pt-2">
                  <p className="font-sans font-bold text-[#490057] text-lg">User Name</p>
                  <p className=" font-sans  text-[#490057] text-[65%]">Occupation</p>
               </div>
               <div>
                  <button className="text-[#490057] border-[1px] border-[#490057] border-solid w-[5rem] h-[1.7rem] sm:w-[7rem] sm:h-[2rem] text-[60%] rounded-md bg-transparent font-semiboldfont-sans">
                     Edit profile
                  </button>
               </div>
            </div>
