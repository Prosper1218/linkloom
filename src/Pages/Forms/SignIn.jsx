         ...
         <div className=" w-full sm:w-[400px] h-[350px] text-white box mt-52 ">
            ...
            <form action="" className="px-4 relative">
               <input
                  ...
                  name="Email"
                  id="Email"
                  className="w-full h-9 border-[0.5px] text-black border-black border-solid focus:outline-none rounded-md bg-transparent pl-4 text-xs mb-6"
                  placeholder="Email..."
               />
               <input
               ...
               />
               {/* <button type="button" className="absolute left-[22rem] top-[5rem]" onClick={togglepassword}>
                  {ShowPassword ? <EyeNoneIcon /> : <EyeOpenIcon />}
               </button> */}
               <p className=" text-left text-xs font-thin mt-1 mb-4 pl-2 text-black">
                  don't have an account? <Link to={'/SignUp'}>Sign up</Link>
               </p>
               <button className="w-full h-9 rounded-md border-none text-[55%] items-center [font-family:'Inter-Bold',Helvetica] bg-[#490057] text-white" onClick={handlesubmit}>
                  LOGIN
               </button>
            </form>
         </div>
