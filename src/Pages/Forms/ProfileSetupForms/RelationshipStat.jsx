      ...
      <div className="min-h-[100vh]" style={{backgroundColor: theme === "dark" ? "#222222" : "#F7F7F8"}}>
         ...
         <div className="flex justify-center px-3">
            <div className=" w-[500px]">
               <form className="grid gap-0 sm:gap-3 grid-cols-1 sora" ref={relationshipref}>
                  <select
               ...
               <button className="float-right h-[2.8rem] rounded-[4px] w-24 montserrat bg-[#480057] capitalize text-xs text-white font-serif" onClick={handlesubmit}>
                  next
               </button>
            </div>
         </div>
