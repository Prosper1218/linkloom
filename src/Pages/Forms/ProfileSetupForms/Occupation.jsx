   ...
   return (
      <div className="min-h-[100vh]" style={{backgroundColor: theme === "dark" ? "#222222" : "#F7F7F8"}}>
         ...
         >
            ...
            <p className="text-xs pt-2"  style={{color: theme === "dark" ? "#F7F7F8" : "#480057"}}>tell us what you do for a living</p>
         </h4>
         <div className="flex justify-center px-5">
            <div className=" w-[500px]">
               <form className="grid gap-0 sm:gap-3 grid-cols-1" ref={occupationref}>
                  <input
                     type="text"
                     name="Job"
                     id="Job"
               ...
               <button className="float-right h-8 w-24 bg-[#480057] capitalize font-serif text-white text-xs" onClick={handlesubmit}>
                  next
               </button>
            </div>
         </div>
